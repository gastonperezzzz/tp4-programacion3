...
public class MainRefactorizado implements CommandLineRunner {
    ...
    private void demostrarBusqueda(List<Transaction> transacciones) {
        ...
        System.out.println("  Comparaciones: " + resultadoLineal.comparisons());
        System.out.println("  Tiempo: " + PerformanceReport.formatNanos(resultadoLineal.nanos()));
        ...
        System.out.println("  Comparaciones: " + resultadoBinaria.comparisons());
        System.out.println("  Tiempo: " + PerformanceReport.formatNanos(resultadoBinaria.nanos()));
    }
